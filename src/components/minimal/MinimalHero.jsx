...
const MinimalHero = () => {
    ...
    return (
        <div className="relative">
            ...
            <div className=" max-h-[85px] flex items-center px-7 justify-between sticky top-0 z-[999] border-b border-white navBorder">
                <ul className='flex gap-3 items-center'>
                    <li><a href="" className='text-[#E8E2DA] text-[14px] nav-item'>Articles</a></li>
                    <li><a href="" className='text-[#E8E2DA] text-[14px] nav-item'>Shop</a></li>
                    <li><a href="" className='text-[#E8E2DA] text-[14px] nav-item'>Submit</a></li>
                </ul>
                ...
                <p className='text-[#E8E2DA] text-[14px] text-nowrap nav-item'>(2021), All rights reserved</p>
            </div>
